...
## **The interface**
As it can be seen in the figure above, the interface is very simple and only have 3 fields you need to worry about.
<br><br />
...
There two ways of using this methods. You can either use it to see what variables are significantly describing the variable to characterize or you can set the __*Significance threshold*__ to 100 so that you have the indicators (R², correlation, etc.) for all the variables.\
...
We can see that for a threshold of 0.05, none of the categorical variable significantly describe the LDFL variable. However, the 3 continuous variables are significantly correlated (for a threshold of 0.05) to LDLF with correlations between 0.5 and 0.6.
<br><br />
