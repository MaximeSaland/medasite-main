---
title: "Description of variable by categorical / quantative data"
output:
  html_document:
    toc: True
    toc_float: True
...
Unlike the first **Automatic Univariate Description** method, you shouldn't try yo set a significance threshold too high. Otherwise, the analysis will run for a very long time (since there might be hundreds of different words) and might not even finish.
