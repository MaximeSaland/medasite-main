...
```
<br><br />
Since this part of the interface is identical in all three methods of the **Multivariate Analysis** submenu, you should go see the explanation on the [PCA page](PCA.html#numerical-indicators) where it has already been covered.
<br><br />

# **Potential issue(s)**

Unlike the PCA, where the *Number of factors* in the __*Automatic Description of the Axes*__ section must be lesser than or equal to the number of active variable, here it must be strictly lower to the number of active variable (columns in this context). If this condition is not met, an error will occur (see below).