...
The data set used for this demo is the decathlon data set. All the option are checked and the *Grouping variable* option is set to 1 to color the individual based on the competition they participated in. We set the value as 1 becaus Competition is the first (and only) categorical variable selected.
...
### Variable table (coordinates, contributions, cosines)
